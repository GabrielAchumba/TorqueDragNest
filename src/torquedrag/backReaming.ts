...
export class BackReaming {

    public static RunBackReamingOperation(pipes:Pipe[], operation:Operation,
        ...
        casingFF:number = null, openHoleFF:number = null):OperationResult[]
    {
        ...
        for (ii = 0; ii < pipesLength; ii++)
        {
            ...
            if (ii == 0)
            {
                operationResult.tensionBottomOfPipe = operation.overpullBackReaming * M;
                operationResult.torqueBottom = operation.torqueAtBitBackReaming;
