export class Inertia_Clearance
{
    public static MomentOfInertia(outerDiameter:number, innerDiameter:number,
    ...
    public static PolarMomentOfInertia(outerDiameter:number, innerDiameter:number,
    ...
    public static RadialClearance(holeDiameter:number, pipeOuterDiameter:number,
