...
export class RotatingOffBottom {
    ...
    for (ii = 0; ii < pipesLength; ii++)
    {
        ...
        //if (ii == 0)
        //{
        //    operationResult.tensionBottomOfPipe = 0;// operation.weightOnBit * M;
        //    operationResult.torqueBottom = operation.torqueAtBitDrillingOperation;
        ...
        operationResult.torqueBottom = 0; // operation.torqueAtBitDrillingOperation;
        ...
        const dragF:number = 0;
        //Drag.DragForce(operationResult.normalForce,
        //        frictionFactor,
        //        1, 1, 1);
        ...
        const dbo2 = Math.pow(baseOperationResult.pipeOuterArea, 2);
