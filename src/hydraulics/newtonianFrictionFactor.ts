...
export const newtonianFrictionFactor = {
    pipeLaminarFlow(ReynoldsNumber:number):number{
        const frictionFactor:number = 16.0 / ReynoldsNumber;
        return frictionFactor;
    },

    annularLaminarFlow(ReynoldsNumber:number):number{
        const frictionFactor:number = 24.0 / ReynoldsNumber;
        return frictionFactor;
    },

    pipeTurbulentFlow(ReynoldsNumber:number, innerDiameter:number,
    ...
    annularTurbulentFlow(ReynoldsNumber:number, pipeOuterDiameter:number, 
